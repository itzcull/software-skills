---
name: test-design
description: Authoritative resource on writing great tests: behavior-focused test design, test levels, test doubles, integration testing, E2E/browser testing, test data factories, and anti-patterns. Use when designing test strategies, choosing test levels, writing resilient tests, selecting mocks/stubs/fakes/spies, or reviewing test quality.
license: MIT
version: 1.0.0
metadata:
  author: itzcull
...
- Deciding whether to use mocks, stubs, spies, fakes, or real collaborators
...
- Do not mock what you do not own; create your own abstraction and prove adapters with integration tests
...
- [Testing Guidelines](references/testing-guidelines.md) - Core principles, test levels, mocking philosophy, test data patterns, coverage guidance, React testing, and anti-patterns
